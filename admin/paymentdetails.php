<?php
            ...
            if(isset($_POST['serial_id'])){
                ...
                // printf("ok");
                    ...
                    $sql = "UPDATE gateway
                    SET pay_status = 'varified'
                    WHERE serial_id=$id";
                    if ($conn->query($sql) === TRUE) {
                        $sql = "UPDATE user_info
                        SET sub_status = 'varified'
                        WHERE user_id='$userid' and connected_ispid='$ispid' and package_name='$p_name' and sub_status='pending'";
                        if ($conn->query($sql) === TRUE) {
                    ...
                    <div class='mainbody'>
                        ...
                        <div class='bg-color'>
                            <?php
                                ...
                                $query = "SELECT * from gateway where serial_id = '$id' ";
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            print("<form id='' class='' action='#' method='POST' autocomplete='off' enctype='multipart/form-data'>
                                                    <!-- <h3 class=' text-white pt-5'></h3> -->
                                                        ...
                                                        <br>
                                                        <input type='text' name='ispname' id='isp Name' value='$isp_name' class='' required>
                                                        <br>

                                                        <label for='area' class=''><b>Customer Name:</b></label> 
                                                        </br>
                                                        <input type='text' name='username' id='area' value='$user_name' class='' required>
                                                        <br>

                                                        <label for='address' class=''><b>Paid amount:</b></label> 
                                                        <br>
                                                        <input type='text' name='amount' id='address' value='$paid' class='' required> 
                                                        <br>

                                                        <label for='mobile' class=''><b>Account No:</b></label> 
                                                        <br>
                                                        <input type='text' name='mobile' id='mobile' value='$pay_number' class='' required>
                                                        <br>

                                                        <label for='mobile' class=''><b>Transaction id:</b></label> 
                                                        <br>
                                                        <input type='text' name='phn' id='mobile' value='$tnx_id' class='' required>
                                                        <br>

                                                        <label for='mobile' class=''><b>Pay Method:</b></label> 
                                                        <br>
                                                        <input type='text' name='phn' id='mobile' value='$pay_method' class='' required>
                                                        <br>
                                                    

                                                        <input type='hidden' name='serial_id' id='' value='$id' class=''>
