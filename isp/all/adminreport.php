                ...
                <div class='outer'>
                    <div class='topbar'>
                        <div class='topleft'>
                            ...
                            <a class='active' href='adminreport.php'>Users & Complain</a>
                                ...
                                <div >
                                        <table >
                                            ...
                                            <?php
                                                    ...
                                                    $query = "SELECT s.subscriber_name,s.package_name,s.subscriber_address,s.subscriber_phone,s.subscriber_id,s.complain,s.reply,i.isp_id FROM isp_admin i JOIN subscriber_list s ON(i.isp_id = s.isp_id)  WHERE s.isp_id = '$id'";
                                                    ...
                                                    if ($result = $conn->query($query)) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            <form action='reportsubmitdatabase.php' method='post'>

                                                            <td> <textarea name='complain'  cols =20 wrap='virtual' placeholder='%s' ></textarea> </td> 
                                                            <td> 
                                                            <input  type='hidden' name='ispid' value='%s'> 
                                                            <input  type='hidden' name='packagename' value='%s'>
                                                            <input  type='hidden' name='userid' value='%s'>
                                                            ...
                                                            , $row["subscriber_name"], $row["package_name"],$row["subscriber_address"],$row["subscriber_phone"]
                                                            ,$row["complain"],$row["reply"],$row["isp_id"], $row["package_name"],$row["subscriber_id"]  );
                                                            printf("</tr>");
                                                        }
